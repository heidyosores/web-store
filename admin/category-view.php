...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=categorylist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Categoría 
        de productos</a>
    </li>
</ul>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                ...
                <form action="/Tareas/regcategori.php" method="POST" class="FormCatElec" data-form="save">
