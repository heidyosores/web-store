                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                        	...
                        	<td class="text-center">
                        		<?php
                        			$prov=ejecutarSQL::consultar("SELECT NombreProveedor FROM proveedor WHERE RUCProveedor='".$prod['RUCProveedor']."'");
                        	...
                        	<td class="text-center">
                        		<form action="Tareas/delprod.php" method="POST" class="FormCatElec" data-form="delete">
