	...
	<div class="row">
		<div class="col-xs-12">
            <div class="container-form-admin">
                ...
                <form action="Tareas/regprove.php" method="POST" class="FormCatElec" data-form="save">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label">RUC/DNI</label>
                                    <input class="form-control" type="text" name="prove-ruc" pattern="[0-9]{1,20}" maxlength="20" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Página Web (opcional)</label>
