    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p class="fa fa-mobile" style="font-size:20px"  aria-hidden="true">  00000000 / 0000000</p> <br />
                E-mail: <a href="#" target="_blank" > &nbsp; ejemplod@dominio.com</a>
            </div>
        </div>
    </div>
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">Minimarket Carmencita &copy; Desarrollado por los estudiantes de la universidad Continental 2021</h5>
</footer>
