...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">Minimarket Carmencita <img src="./assets/img/logo.jpg" width="50"></p>
            </div>
            <div class="col-xs-8">
                ...
                <a href="/configAdmin.php?view=categorylist"  class="table-cell-td">Categorias</a>
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                        ...
                        echo '
                           <a href="#" data-toggle="modal" data-target=".modal-login" id="button-login-xs" class="table-cell-td">
        ...
        <div class="row visible-xs"><!-- Mobile menu navbar -->
            <div class="col-xs-12">
                ...
                <?php
                if(!$_SESSION['nombreAdmin']==""){echo '<a href="#"  id="button-login-xs" class="elements-nav-xs exit-system">
    ...
    <div class="modal fade modal-login" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            ...
            <form action="Tareas/login.php" method="post" role="form" class="FormCatElec" data-form="login">
    ...
    <div class="modal fade" id="ModalUpUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="Tareas/updateClient.php" method="POST" data-form="save" autocomplete="off">
          <div class="modal-header">
