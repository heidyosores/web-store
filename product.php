            ...
            ?>
              <div class="row">
                ...
                <?php
                    ...
                    echo '<h3 class="text-center">Lo sentimos, no hay productos registrados<strong>"'.$datCat['Nombre'].'"</strong></h3>';
                  }
                ?>
              </div>
            <?php
                }else{
                  echo '<h3 class="text-center">Por favor seleccione una categoría</h3>';
                }
              else:
                echo '<h3 class="text-center">Lo sentimos, no hay productos ni categorías registradas en la tienda</h3>';
              endif;
            ?>
        </div>
    </section>
