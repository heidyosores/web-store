       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>Busqueda de Productos <small class="tittles-pages-logo">STORE</small></h1>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <?php
                    ...
                    $consultar_productos=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM producto WHERE NombreProd LIKE '%".$search."%' OR Marca LIKE '%".$search."%' LIMIT $inicio, $regpagina");
                    ...
                    if(mysqli_num_rows($consultar_productos)>=1){
                      echo '<div class="col-xs-12"><h3 class="text-center">Resultador Encontrados <strong>"'.$search.'"</strong></h3></div><br>';
                  ...
                  <?php
                      ...
                      echo '<h2 class="text-center">Lo sentimos, no hemos encontrado productos con esa palabra <strong>"'.$search.'"</strong></h2>';
                    }
                  ?>
                </div>
              </div>
